		...
		<div class="col-md-12 main">
			...
			<!--  Empieza panel para crear evento -->
	     			<div class="panel panel-success">
						<div class="panel-heading"><h3 class="panel-title">Crear nuevo evento:</h3></div>
							<ol class="breadcrumb text-center">
	...
	<!--  Termina panel para crear evento -->
		...
		<%-- 		entender que esta pasando.' --%>
				...
				<div class="panel panel-warning">
					<div class="panel-heading"><h3 class="panel-title">Modificar cuotas de un evento:</h3></div>
							<ol class="breadcrumb text-center">
			...
			<!--  Empieza panel para finalizar evento -->	
					<div class="panel panel-danger">
						...
						<div class="panel-heading acomodar"><h3 class="panel-title">Finalizar eventos: </h3>
							...
							<ol class="breadcrumb text-center">
	          					<li class="breadcrumb-item active">Desde aquí podrá finalizar un evento, cargando el resultado de un partido terminado y la cuota ganadora del evento.</li>
	     					</ol>
						<div class="container-fluid">
